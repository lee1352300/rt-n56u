                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="wl_country_code" class="input" onChange="return change_common_wl(this, 'WLANConfig11a', 'wl_country_code')">
                                                    ...
                                                    <option value="DB" <% nvram_match_x("", "wl_country_code", "CH","selected"); %>>Switzerland (channels 36,40,44,48,52,56,60,64,100,104,108,112,116,120,124,128,132,136,140)</option>
